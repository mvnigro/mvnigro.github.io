...
$mail = new PHPMailer\PHPMailer\PHPMailer();
    ...
    $mail->Username   = 'site@vnigro.net';   //SEU USUÁRIO DE EMAIL
    ...
    //Recipients
    $mail->setFrom('site@vnigro.net', 'Quote from Site');  //DEVE SER O MESMO EMAIL DO USERNAME
    $mail->addAddress('site@vnigro.net');     // QUAL EMAIL RECEBERÁ A MENSAGEM!
